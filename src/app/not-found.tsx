...
export default function NotFoundPage() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-950 p-4 font-sans text-center">
      <div className="max-w-md w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-8 shadow-sm space-y-5">
        ...
        <div className="space-y-2">
          ...
          <h2 className="text-lg font-bold text-slate-800 dark:text-slate-200">Halaman Tidak Ditemukan</h2>
